...
SOURCES=main.c altrom.c audio.c ay.c bootrom.c buffer.c config.c cpu.c dac.c divmmc.c esp.c i2c.c io.c joystick.c keyboard.c log.c memory.c mf.c mmu.c mouse.c nextreg.c paging.c rom.c rtc.c sdcard.c slu.c spi.c uart.c utils.c
OBJECTS=$(SOURCES:.c=.o)
