...
typedef enum {
  ...
  E_NEXTREG_REGISTER_PS2_KEYMAP_ADDRESS_MSB                = 0x28,
  E_NEXTREG_REGISTER_PS2_KEYMAP_ADDRESS_LSB                = 0x29,
  ...
  E_NEXTREG_REGISTER_VERTICAL_LINE_COUNT_OFFSET            = 0x64,
  E_NEXTREG_REGISTER_ULA_CONTROL                           = 0x68,
  E_NEXTREG_REGISTER_DISPLAY_CONTROL_1                     = 0x69,
  E_NEXTREG_REGISTER_LO_RES_CONTROL                        = 0x6A,
  ...
  E_NEXTREG_REGISTER_EXPANSION_BUS_ENABLE                  = 0x80,
  E_NEXTREG_REGISTER_EXPANSION_BUS_CONTROL                 = 0x81,
  ...
  E_NEXTREG_REGISTER_EXPANSION_BUS_IO_PROPAGATE            = 0x8A,
  ...
  E_NEXTREG_REGISTER_PI_GPIO_OUTPUT_ENABLE_0               = 0x90,
  E_NEXTREG_REGISTER_PI_GPIO_OUTPUT_ENABLE_1               = 0x91,
  E_NEXTREG_REGISTER_PI_GPIO_OUTPUT_ENABLE_2               = 0x92,
  E_NEXTREG_REGISTER_PI_GPIO_OUTPUT_ENABLE_3               = 0x93,
  E_NEXTREG_REGISTER_PI_PERIPHERAL_ENABLE                  = 0xA0,
  E_NEXTREG_REGISTER_PI_I2S_AUDIO_CONTROL                  = 0xA2,
  E_NEXTREG_REGISTER_ESP_WIFI_GPIO_OUTPUT_ENABLE           = 0xA8,
  E_NEXTREG_REGISTER_DIVMMC_ENTRY_POINTS_0                 = 0xB8,
  E_NEXTREG_REGISTER_DIVMMC_ENTRY_POINTS_0_VALID           = 0xB9,
  E_NEXTREG_REGISTER_DIVMMC_ENTRY_POINTS_0_TIMING          = 0xBA,
  E_NEXTREG_REGISTER_DIVMMC_ENTRY_POINTS_1                 = 0xBB,
  ...
  E_NEXTREG_REGISTER_INT_EN_1                              = 0xC5,
  E_NEXTREG_REGISTER_INT_EN_2                              = 0xC6,
  E_NEXTREG_REGISTER_DMA_INT_EN_0                          = 0xCC,
  E_NEXTREG_REGISTER_DMA_INT_EN_1                          = 0xCD,
  E_NEXTREG_REGISTER_DMA_INT_EN_2                          = 0xCE,
